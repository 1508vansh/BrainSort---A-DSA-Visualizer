...
//                 {/* Extra Button */}
//                 <button className="hidden lg:block px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 rounded-lg text-white font-semibold text-lg transition-all shadow-lg hover:shadow-xl">
//                   Race Mode
//                 </button>
//               </div>
//             </div>
...
//               <button className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 rounded-lg text-white font-semibold text-lg transition-all shadow-lg hover:shadow-xl">
//                 Race Mode
//               </button>
//             </div>
//           </Disclosure.Panel>
...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="navbar shadow-lg" style={{ backgroundColor: "var(--nav-bg)" }}>
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="relative flex h-20 items-center justify-between">
